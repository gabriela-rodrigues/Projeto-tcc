...
$(function () {
    if (typeof (Storage) !== "undefined") {
        ...
        iziToast.warning({
            title: 'Cuidado',
            message: "Desculpe, mas seu navegador não suporta armazenamento local, portanto, este aplicativo não funcionará como pretendido. Tente atualizar seu navegador primeiro.",
            overlay: true,
            zindex: 999,
            position: 'center',
            timeout: 20000,
...
let months = ["Janeiro", "Fevereiro", "Março", "Abril", "Maio", "Junho", "Julho", "Agosto", "Setembro", "Outubro", "Novembro", "De"];
...
$("#days td.inactive").on("click", function () {
    iziToast.error({
        title: 'Erro',
        message: "Você pode marcar consultas hoje mesmo e ou deste dia em seguinte.",
        overlay: true,
        zindex: 999,
        position: 'center',
        timeout: 3000,
...
function make_appointment() {
    if (is_empty() == false) {
        ...
        if (is_overlap() == false) {
            ...
            iziToast.error({
                title: 'Erro',
                message: "Já existem consultas marcadas com esses mesmo dados: dia e horário.",
                overlay: true,
                zindex: 999,
                position: 'center',
                timeout: 3000,
        ...
        iziToast.error({
            title: 'Erro',
            message: "Todos os campos de entrada são necessários para marcar uma consulta.",
            overlay: true,
            zindex: 999,
            position: 'center',
            timeout: 3000,
...
function clear_storage(){
    ...
    iziToast.success({
        title: 'Sucesso',
        message: 'Todas as consultas foram desmarcadas.',
    });
}
